...
data_arg.add_argument('--node_num', type=int, default=90, help='Service number of web composition')  #30  需要修改
...
misc_arg.add_argument('--ist_nodeset', type=str, default='w', help='the ist nodeset.txt')#1
